...
int main(void) {
    unsigned int n = 5; // 00000101 en binario
    printf("Antes de establecer el bit 3: %u\n", n);
    
    n = n | (1 << 3); // Establece el bit 3 (contando desde 0)
    
    printf("Después de establecer el bit 3: %u\n", n);
    return 0;
}

// Antes de establecer el bit 3: 5
// Después de establecer el bit 3: 13
